...
container = st.empty()
if st.session_state.get("translator_conversation_id"):
    init_chat(container, "translator_conversation_id")
else:
    with container.form("translator_form", clear_on_submit=True):
